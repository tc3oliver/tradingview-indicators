...
| [btc-intraday-trade-planner](./btc-intraday-trade-planner/) | Study IT1: 36 pre-registered 15m intraday candidates (opening-range breakout, liquidity sweep & reclaim, VWAP reclaim; London and New York; long and short; ±1H context) plus 108 robustness neighbours, against nine gates. 31 rejected, 5 insufficient, 0 passed. Gross of costs the setups are coin flips; a 0.14% round trip on a 40–200 bp stop is 0.1–0.5 R. No intraday strategy was built. Includes a DST-correct session seasonality audit |
